...
class PlatoInformationScreen extends StatelessWidget {
  const PlatoInformationScreen({super.key});
        ...
        PageViewModel(
          ...
          bodyWidget: SingleChildScrollView(
            child: Column(
              ...
              children: [
                Center(
                  child: Image.asset('lib/data/img/plato.png', width: 350),
                ),
        ...
        PageViewModel(
          ...
          bodyWidget: SingleChildScrollView(
            child: Column(
              mainAxisAlignment: MainAxisAlignment.center,
              children: [
                Icon(FontAwesomeIcons.cow.data, size: 150, color: Colors.white),
                SizedBox(height: 20),
                Text(
        ...
        PageViewModel(
          ...
          bodyWidget: SingleChildScrollView(
            child: Column(
              ...
              children: [
                Icon(
                  FontAwesomeIcons.wheatAwn.data,
                  size: 150,
                  color: Colors.white,
                ),
                SizedBox(height: 20),
